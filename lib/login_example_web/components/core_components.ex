defmodule LoginExampleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LoginExampleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LoginExampleWeb.Gettext, "errors", msg, opts)
    end
  end
